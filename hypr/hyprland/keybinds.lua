...
hl.bind("SUPER + ALT + R", hl.dsp.exec_cmd("caelestia record --stop"))
...
hl.bind("SUPER + I", hl.dsp.exec_cmd("pkill fuzzel || caelestia emoji -p"))
...
hl.bind("CTRL + M", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"), { locked = true })

-- Custom Microphone Controls
hl.bind(
	"ALT + Up",
	hl.dsp.exec_cmd(
		"wpctl set-mute @DEFAULT_AUDIO_SOURCE@ 0; wpctl set-volume @DEFAULT_AUDIO_SOURCE@ " .. vars.volumeStep .. "%+"
	),
	{ locked = true, repeating = true }
)
hl.bind(
...
hl.bind("ALT + M", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { locked = true })

-- Custom Brightness Controls
hl.bind("SHIFT + Up", hl.dsp.global("caelestia:brightnessUp"), { locked = true })
hl.bind("SHIFT + Down", hl.dsp.global("caelestia:brightnessDown"), { locked = true })
